...
namespace Tiger_YH_Admin
{
	static class Menu
    {
        ...
        public static void ManageStudents()
        {
            ...
            switch (menuChoice)
            {
                case 1: Console.WriteLine("Visar studeninformation"); //TODO : Fixa metod
                    break;
                case 2: Console.WriteLine("Ändrar studentinformation"); //TODO: Fixa metod
                    break;
                case 3: Console.WriteLine("Sätt betyg på student"); //TODO: Fixa metod
                    break;
                case 4: AddStudentToClass();
                    break;
                case 5: Console.WriteLine("Ta bort student från klass"); //TODO: Fixa metod
                    break;
                default:
                    break;
            }
